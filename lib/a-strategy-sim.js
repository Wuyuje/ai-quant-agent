...
const CONFIG = {
  ...
  // 只交易这3个币
  // 精选币池(30/90天真实资金回测双稳·多次成交·高胜率): 按回报排名前10
  // 最强: BCH/ARB/TURBO/INJ/1000PEPE | 稳健: ETH/LINK/SEI/WIF/SOL
  tradeSymbols: ["BCHUSDT","ARBUSDT","TURBOUSDT","INJUSDT","1000PEPEUSDT","ETHUSDT","LINKUSDT","SEIUSDT","WIFUSDT","SOLUSDT"],
