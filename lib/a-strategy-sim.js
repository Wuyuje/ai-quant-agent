...
const CONFIG = {
  ...
  profitTriggerPct: 8.0,      // v10: 浮盈≥8%才触发移动止盈(让盈利单跑更高,盈亏比>1)
  trailDrawdownPct: 4.0,      // v10: 峰值回撤4%锁利(保护在高位利润,但给趋势空间)
  totalLossPct: 5,            // v10: 硬止损5%(单笔亏损更小) — 盈亏比约8:5=1.6:1
  softLossPct: 4,             // v10: 软止损4%(空单更早)
