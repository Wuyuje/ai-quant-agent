...
const CONFIG = {
  ...
  profitTriggerPct: 3.0,      // v13: 浮盈≥3%开始进入移动止盈保护(早点保护,但不触发就锁利)
  trailDrawdownPct: 2.2,      // v13: 峰值回撤2.2%锁利(峰值要跑到5%+才锁利在2.8%+,给盈利奔跑空间)
  breakEvenPct: 4.0,          // v13: 浮盈≥4%后回吐过半才保本锁利(高利润保护,防微利跑路)
  totalLossPct: 6,            // v13: 硬止损6%
  softLossPct: 4,             // v13: 软止损4%
